...
uint256 hashGenesisBlock("0xd1ab744bf2a4be7a2e6fb14215c29bd0d90bbd3bc6a1d30b1199a54098cab681"); //chimark genblock
...
const string strMessageMagic = "ChiCoin Signed Message:\n";
...
{
    int64 nSubsidy = 50 * COIN; //chimark

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // ChiCoin: 19 days adjust diff chimark
static const int64 nTargetSpacing = 5 * 60; // ChiCoin: 5 minute blocks chimark
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal chicoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ChiCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd1ab744bf2a4be7a2e6fb14215c29bd0d90bbd3bc6a1d30b1199a54098cab681");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Dec 2013 light speed X-day"; //chimark
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1386052597; //epochtime chimark
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1992863;

        if (fTestNet)
        {
            block.nTime    = 1386052597; //chimark
            block.nNonce   = 1992863;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xfb3121eafdff07da87c5e5ea06b8d3d039a174621a8a0c494fe5c378328c1360"));
