...
static const int64 MAX_MONEY = 77000000 * COIN; // maximum number of coins chimark
...
public:
    ...
    */
    ...
    {
        // Large (in bytes) low-priority (new, chicoin) transactions
        // need a fee.
        return dPriority > COIN * 288 / 250; // chimark  288 blocks found a day.
    }
